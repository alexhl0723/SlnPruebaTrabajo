...
SELECT * FROM Departamento WHERE NombreDepartamento LIKE '%Puno%';
...
BEGIN
    ...
    LEFT JOIN Distrito dis ON t.IdDistrito = dis.Id
END
...
CREATE OR ALTER PROCEDURE sp_ListarTrabajadoresSexo
    @Sexo CHAR(1) = NULL
AS
BEGIN
    SELECT
